...
$sql = "UPDATE spacem2 SET status='occupied' WHERE location='$space_number'";
...
$sql = "INSERT INTO m2consumer(cname, car_no, location) VALUES ('$car_name', '$car_number','$space_number')";
if (mysqli_query($conn, $sql)) {
