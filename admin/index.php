...
<body>
	...
	<div class="sidebar">
		<ul>
			...
			<li><a href="#" class="menu-link">Elpro City Square Mall</a></li>
			<li><a href="#" class="menu-link">Nexus Westend Mall</a></li>
			<li><a href="#" class="menu-link">Pavillion Mall</a></li>
			<li><a href="#" class="menu-link">Kumar Pacific Mall</a></li>
			<li><a href="#" class="menu-link">Complains</a></li>
