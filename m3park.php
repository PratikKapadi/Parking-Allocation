...
$sql = "UPDATE spacem3 SET status='occupied' WHERE location='$space_number'";
if (mysqli_query($conn, $sql)) {
    echo "Parking space status updated successfully.";
    header("Location: mall3.php");
} else {
    echo "Error updating parking space status: " . mysqli_error($conn);
}

// insert car details into MySQL database
$sql = "INSERT INTO m3consumer(cname, car_no, location) VALUES ('$car_name', '$car_number','$space_number')";
if (mysqli_query($conn, $sql)) {
