...
$sql = "UPDATE spacem4 SET status='occupied' WHERE location='$space_number'";
if (mysqli_query($conn, $sql)) {
    echo "Parking space status updated successfully.";
    header("Location: mall4.php");
} else {
    echo "Error updating parking space status: " . mysqli_error($conn);
}

// insert car details into MySQL database
$sql = "INSERT INTO m4consumer(cname, car_no, location) VALUES ('$car_name', '$car_number','$space_number')";
if (mysqli_query($conn, $sql)) {
