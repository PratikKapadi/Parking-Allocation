...
<html>
  ...
  <header>
    ...
    <div class="header">
      <h1>Elpro City Square Mall</h1>
      <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
      <div class="button">
      <div class="button_box"><a href="m1park.php" class="text">Park</a></div>
      <div class="button_box"><a href="leavem1.php" class="text">Leave</a></div> 
      <div class="button_box"><a href="https://www.google.com/maps/place/Elpro+City+Square+Mall/@18.628753,73.7819924,17z/data=!3m1!4b1!4m6!3m5!1s0x3bc2b9ba9ff8681f:0x1693d6e9f4d1d4ab!8m2!3d18.628753!4d73.7841811!16s%2Fg%2F11f03xlbt_" class="text">Direction</a></div>
    </div>
    <div class="green">
